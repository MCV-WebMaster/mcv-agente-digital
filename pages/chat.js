    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-grow p-4 pb-24">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          {/* Mensaje de Bienvenida (Hardcoded visualmente) */}
          {messages.length === 0 && (
                        ...
                        <div key={toolCallId} className="mt-4">
                          ...
                          <div className="grid grid-cols-1 gap-4">
                            {result.properties.map(prop => (
                              // Reutilizamos nuestra PropertyCard existente
                              // Pasamos filtros vacíos solo para que no falle la lógica de fechas
                              <PropertyCard key={prop.property_id} property={prop} filters={{}} onContact={() => {}} />
                            ))}
                          </div>
                        </div>
                      );
