/**
 * Lógica de negocio v12 (Mapeo Cruzado Real)
 * Mapea los slugs "raros" de WP a los períodos reales de 2026.
 */

// --- MAPEO DE DISPONIBILIDAD REAL ---
const PERIOD_MAP = [
  // 1. Navidad (Slug: navidad) -> OK
  { key: 'wp_navidad', name: 'Navidad', start: '2025-12-19', end: '2025-12-26' },
  
  // 2. Año Nuevo (Slug: ano-nuevo) -> OK
  { key: 'wp_ano_nuevo', name: 'Año Nuevo', start: '2025-12-26', end: '2026-01-02' },
  
  // 3. Año Nuevo c/1ra Enero (Slug: enero-1ra-quincena) -> CRUZADO
  { key: 'wp_combo_an_e1', name: 'Año Nuevo con 1ra Enero', start: '2025-12-30', end: '2026-01-15' },
  
  // 4. Enero 1ra (Slug: enero-2da-quincena) -> CRUZADO
  { key: 'wp_ene_1ra', name: 'Enero 1ra Quincena', start: '2026-01-02', end: '2026-01-15' },
  
  // 5. Enero 2da (Slug: febrero-1ra-quincena) -> CRUZADO
  { key: 'wp_ene_2da', name: 'Enero 2da Quincena', start: '2026-01-16', end: '2026-01-31' },
  
  // 6. Febrero 1ra / Carnaval (Slug: febrero-2da-quincena) -> CRUZADO
  { key: 'wp_feb_1ra', name: 'Febrero 1ra Quincena', start: '2026-02-01', end: '2026-02-17' },
  
  // 7. Febrero 2da (Slug: diciembre-2da-quincena) -> CRUZADO
  { key: 'wp_feb_2da', name: 'Febrero 2da Quincena', start: '2026-02-18', end: '2026-03-01' },
];
