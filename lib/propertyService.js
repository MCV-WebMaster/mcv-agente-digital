...
const PERIOD_MAPPING = {
  'Navidad': 'navidad',
  'Año Nuevo': 'ano-nuevo',
  'Enero Combinado': 'enero-1ra-quincena', // EL SLUG DE LA QUINCENA COMBINADA
  'Enero 1ra Quincena': 'enero-2da-quincena', // SLUG SEGÚN TU LISTA
  ...
  if (operacion === 'alquiler_temporal') {
    ...
    for (const period of allPeriodsData || []) {
        ...
        if (targetPeriodSlug) {
            ...
            // Usamos includes del SLUG contra el nombre de la DB para ser flexibles
        ...
        // FIX CRÍTICO: Agregamos el ID al Set AUNQUE el precio sea 0 (para mostrar "Consultar")
        if (isMatch) {
